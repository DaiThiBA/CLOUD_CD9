...
namespace ITGoShop_F_Ver2.Models
{
    ...
    {
        private const string connectionString = "server=dbtechtrove.mysql.database.azure.com ; port=3306 ; database=techtrove;user id=daithi;password=abcd@1234;Convert Zero Datetime=True";
